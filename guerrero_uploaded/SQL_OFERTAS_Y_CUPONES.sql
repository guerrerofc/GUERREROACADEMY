-- ========================================
-- FASE 4 & 5: OFERTAS ASIGNABLES + CUPONES
-- Guerrero Academy
-- ========================================
...
SELECT 'offer_assignments' as tabla, COUNT(*) FROM offer_assignments
UNION ALL
SELECT 'discount_coupons' as tabla, COUNT(*) FROM discount_coupons
UNION ALL
SELECT 'coupon_usage' as tabla, COUNT(*) FROM coupon_usage;
